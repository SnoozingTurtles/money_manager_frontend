  ...
  TransactionBloc(
    ...
    on<AddTransaction>((event, emit) async {
      ...
      var expense =  (_userBloc.state as UserLoaded).user.expense;
        ...
        _userBloc.add(ReloadUser(balance: balance,expense:expense,income:income+state.amount.value.fold((l) => 0, (r) => double.parse(r))));
        ...
        addTransactionInput = AddExpenseInput(
            ...
            medium: state.medium);
        balance -= state.amount.value.fold((l) => 0, (r) => double.parse(r));
        _userBloc.add(ReloadUser(balance: balance,income:income,expense:expense+state.amount.value.fold((l) => 0, (r) => double.parse(r))));
